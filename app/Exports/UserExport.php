    ...
    public function map($user): array
    {
        ...
        $userType = UserType::lists();
         ...
         return[
             ...
             $user->EmployeeJobDetail->Department->name,
             $user->EmployeeJobDetail->Division->name,
             $user->EmployeeJobDetail->EmployeeType->name,
             $user->EmployeeJobDetail->Designation->name,

...
Route::prefix('/')->middleware(['auth', 'blocked'])->group(function () {
    ...
    Route::prefix('/employee')->group(function () {
        Route::middleware('admin_and_hr')->group(function () {
    ...
    Route::prefix('/department')->middleware('admin')->group(function () {
    ...
    Route::prefix('/designation')->middleware('admin')->group(function () {
    ...
    Route::prefix('/division')->middleware('admin')->group(function () {
    ...
    Route::prefix('/payslip-download-reason')->middleware('admin')->group(function () {
    ...
    Route::prefix('/organization')->middleware('admin')->group(function () {
    ...
    Route::prefix('/employee-type')->middleware('admin')->group(function () {
    ...
    Route::prefix('/mode-of-exit')->middleware('admin')->group(function () {
    ...
    Route::prefix('/payslip')->group(function () {
        ...
        Route::get('/delete/{id}', [PayslipController::class, 'delete', 'as' => 'admin.payslip.delete'])->name('payslip_delete')->middleware('admin');
    });

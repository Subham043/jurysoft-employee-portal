                                ...
                                <div class="row gy-4">
                                    ...
                                    <div class="col-xxl-4 col-md-4">
                                        <div>
                                            ...
                                            <input type="text" class="form-control" disabled readonly name="total_days_of_month" id="total_days_of_month" value="{{old('total_days_of_month')}}">
                                    ...
                                    <div class="col-xxl-3 col-md-3">
                                        <div>
                                            ...
                                            <input type="text" class="form-control" name="paid_leave_taken" id="paid_leave_taken" value="{{old('paid_leave_taken')}}">

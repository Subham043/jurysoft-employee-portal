...
<div class="page-content">
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <form id="countryForm" method="post" action="{{route('payslip_update', $country->id)}}" enctype="multipart/form-data">
                @csrf
                    <div class="card">
                                ...
                                <div class="row gy-4">
                                    ...
                                    <div class="col-xxl-4 col-md-4">
                                        <div>
                                            ...
                                            <input type="month" class="form-control" name="month_year" id="month_year" oninput="payslip_month_year_change()" value="{{$country->month_year}}"  max={{$max_month}}>
                                            @error('month_year') 
                                                <div class="invalid-message">{{ $message }}</div>
                                            @enderror
                                        </div>

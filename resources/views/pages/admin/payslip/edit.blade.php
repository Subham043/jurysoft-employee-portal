...
<div class="page-content">
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <form id="countryForm" method="post" action="{{route(Auth::user() &&  Auth::user()->userType == 1 ? 'payslip_update' : 'payslip_update_hr', $country->id)}}" enctype="multipart/form-data">
                @csrf
                    <div class="card">
                                ...
                                <div class="row gy-4">
                                    ...
                                    <div class="col-xxl-4 col-md-4">
                                        <div>
                                            ...
                                            <input type="month" class="form-control" name="month_year" id="month_year" oninput="payslip_month_year_change()" value="{{$country->month_year}}">
                                            @error('month_year') 
                                                <div class="invalid-message">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-xxl-3 col-md-3">
                                        <div>
                                            ...
                                            <input type="text" class="form-control" name="working_days_of_month" id="working_days_of_month" oninput="workdays_change()" value="{{$country->working_days_of_month}}">
                                    ...
                                    <div class="col-xxl-3 col-md-3">
                                        <div>
                                            ...
                                            <input type="text" class="form-control" name="unpaid_leave_taken" id="unpaid_leave_taken" oninput="workdays_change()" value="{{$country->unpaid_leave_taken}}">
                                    ...
                                    <div class="col-xxl-3 col-md-3">
                                        <div>
                                            ...
                                            <input type="text" class="form-control" disabled readonly name="worked_days" id="worked_days" value="{{$country->worked_days}}">
                                            @error('worked_days') 
                                                <div class="invalid-message">{{ $message }}</div>
                                            @enderror
                                        </div>
        ...
        @foreach($user as $key => $val)
            {
                ...
                selected: {{$country->user_id==$val->id ? 'true' : 'false'}},
            },
        @endforeach
    ],
    renderChoiceLimit: -1,

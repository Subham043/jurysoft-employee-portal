                            ...
                            <div class="row gy-4">
                                <div class="col-xxl-4 col-md-4">
                                    <div>
                                        ...
                                        <input type="text" class="form-control" name="first_name" id="first_name" oninput="nameChangeHandler()" value="{{$country->first_name}}">
                                        @error('first_name') 
                                ...
                                <div class="col-xxl-4 col-md-4">
                                    <div>
                                        ...
                                        <input type="text" class="form-control" name="last_name" id="last_name" oninput="nameChangeHandler()" value="{{$country->last_name}}">
                                        @error('last_name') 
                                            <div class="invalid-message">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-xxl-4 col-md-4">
                                    <div>
                                        ...
                                        <input type="text" class="form-control" name="full_name" id="full_name" readonly disabled value="{{$country->full_name}}">
                                        @error('full_name') 
                                            <div class="invalid-message">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-xxl-3 col-md-3">
                                    <div>
                                        <label for="jurysoft_id" class="form-label">Jurysoft ID</label>
                                        <input type="text" class="form-control" name="jurysoft_id" id="jurysoft_id" value="{{$country->jurysoft_id}}">
                                        @error('jurysoft_id') 
                                            <div class="invalid-message">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="row gy-4">
                                ...
                                <div class="col-xxl-4 col-md-4">
                                    <div>
                                        ...
                                        <input type="date" class="form-control" name="dob" id="dob" value="{{$country->EmployeePersonalDetail->dob}}">
                                        @error('dob') 
                                            <div class="invalid-message">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-xxl-4 col-md-4">
                                    <div>
                                        ...
                                        <input type="text" class="form-control" name="email_personal" id="email_personal" value="{{$country->EmployeePersonalDetail->email}}">
                                ...
                                <div class="col-xxl-4 col-md-4">
                                    <div>
                                        ...
                                        <input type="text" class="form-control" name="aadhar" id="aadhar" value="{{$country->EmployeePersonalDetail->aadhar}}">
                                        @error('aadhar') 
                                            <div class="invalid-message">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-xxl-4 col-md-4">
                                    <div>
                                        ...
                                        <input type="text" class="form-control" name="pan" id="pan" value="{{$country->EmployeePersonalDetail->pan}}">
                                        @error('pan') 
                                            <div class="invalid-message">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-xxl-6 col-md-6">
                                    <div>
                                        ...
                                        <textarea name="current_address" id="current_address" class="form-control">{{$country->EmployeePersonalDetail->current_address}}</textarea>
                                ...
                                <div class="col-xxl-6 col-md-6">
                                    <div>
                                        ...
                                        <textarea name="permanent_address" id="permanent_address" class="form-control">{{$country->EmployeePersonalDetail->permanent_address}}</textarea>
                            ...
                            <div class="row gy-4">
                                ...
                                <div class="col-xxl-4 col-md-4">
                                    <div>
                                        ...
                                        <input type="date" class="form-control" name="date_of_join" id="date_of_join" value="{{$country->EmployeeJobDetail->date_of_join}}" oninput="trainingEndDateHandler()">
                                        @error('date_of_join') 
                                            <div class="invalid-message">{{ $message }}</div>
                                        @enderror
                                    </div>
                                            ...
                                            <div>
                                                <select name="no_of_training_days_d" id="no_of_training_days_d" class="form-control" oninput="trainingEndDateHandler()">
                                                    ...
                                                    @foreach (range(1,31) as $item)
                                                        <option value="{{$item}}" {{$country->EmployeeJobDetail->no_of_training_days_d==$item?'selected':''}}>{{$item}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div>
                                                <select name="no_of_training_days_m" id="no_of_training_days_m" class="form-control" oninput="trainingEndDateHandler()">
                                                    ...
                                                    @foreach (range(1,12) as $item)
                                                        <option value="{{$item}}" {{$country->EmployeeJobDetail->no_of_training_days_m==$item?'selected':''}}>{{$item}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div>
                                                <select name="no_of_training_days_y" id="no_of_training_days_y" class="form-control" oninput="trainingEndDateHandler()">
                                                    ...
                                                    @foreach (range(1,10) as $item)
                                                        <option value="{{$item}}" {{$country->EmployeeJobDetail->no_of_training_days_y==$item?'selected':''}}>{{$item}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="d-flex align-items-center" style="gap:10px">
                                            <div>
                                                <select name="mou_duration_d" id="mou_duration_d" class="form-control">
                                                    <option value="">Days</option>
                                                    @foreach (range(1,31) as $item)
                                                        <option value="{{$item}}" {{$country->EmployeeJobDetail->mou_duration_d==$item?'selected':''}}>{{$item}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div>
                                                <select name="mou_duration_m" id="mou_duration_m" class="form-control">
                                                    <option value="">Months</option>
                                                    @foreach (range(1,12) as $item)
                                                        <option value="{{$item}}" {{$country->EmployeeJobDetail->mou_duration_m==$item?'selected':''}}>{{$item}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div>
                                                <select name="mou_duration_y" id="mou_duration_y" class="form-control">
                                                    <option value="">Years</option>
                                                    @foreach (range(1,10) as $item)
                                                        <option value="{{$item}}" {{$country->EmployeeJobDetail->mou_duration_y==$item?'selected':''}}>{{$item}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                ...
                                <div class="col-xxl-6 col-md-6">
                                    <div>
                                        ...
                                        <input type="date" class="form-control" name="training_end_date" id="training_end_date" readonly disabled value="{{$country->EmployeeJobDetail->training_end_date}}">
                                ...
                                <div class="col-xxl-6 col-md-6">
                                    <div>
                                        ...
                                        <input type="date" class="form-control" name="date_of_regular" id="date_of_regular" disabled readonly value="{{$country->EmployeeJobDetail->date_of_regular}}">
                            ...
                            <div class="row gy-4">
                                <div class="col-xxl-12 col-md-12">
                                    <div>
                                        ...
                                        <input type="text" oninput="main_gross_salary_change()" class="form-control" name="main_gross_salary" id="main_gross_salary" value="{{$country->main_gross_salary}}">
                            ...
                            <div class="row gy-4">
                                <div class="col-xxl-3 col-md-3">
                                    <div>
                                        ...
                                        <input type="text" class="form-control" name="bank_name" id="bank_name" value="{{$country->EmployeeBankDetail->bank_name}}">
                                        @error('bank_name') 
                                            <div class="invalid-message">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-xxl-3 col-md-3">
                                    <div>
                                        ...
                                        <input type="text" class="form-control" name="account_no" id="account_no" value="{{$country->EmployeeBankDetail->account_no}}">
                                        @error('account_no') 
                                            <div class="invalid-message">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-xxl-3 col-md-3">
                                    <div>
                                        ...
                                        <input type="text" class="form-control" name="ifsc" id="ifsc" value="{{$country->EmployeeBankDetail->ifsc}}">
                                        @error('ifsc') 
                                            <div class="invalid-message">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="row gy-4">
                                <div class="col-xxl-4 col-md-4">
                                    <div>
                                        ...
                                        <input type="text" class="form-control" name="name" id="name" value="{{$country->EmployeeEmergencyDetail->name}}">
                                        @error('name') 
                                            <div class="invalid-message">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-xxl-4 col-md-4">
                                    <div>
                                        ...
                                        <input type="text" class="form-control" name="phone_emergency" id="phone_emergency" value="{{$country->EmployeeEmergencyDetail->phone}}">
                    ...
                    <div class="card-body">
                        <div class="live-preview">
                            <div class="row gy-4">
                                ...
                                <div class="col-xxl-4 col-md-4 {{$country->EmployeeEmploymentDetail->work_status==1?'d-none':''}}" id="exitModeDiv">
                                    <div>
                                ...
                                <div class="col-xxl-4 col-md-4 {{$country->EmployeeEmploymentDetail->work_status==1?'d-none':''}}" id="exitDateDiv">
                                    <div>
                                        <label for="exit_date" class="form-label">Exit Date</label>
                                        <input type="date" class="form-control" name="exit_date" id="exit_date" value="{{$country->EmployeeEmploymentDetail->exit_date}}">
                                        @error('exit_date') 
                                            <div class="invalid-message">{{ $message }}</div>
                                        @enderror
                                    </div>
        ...
        @foreach($bloodType as $key => $val)
            {
                value: '{{$key}}',
                label: '{{$val}}',
                selected: {{$country->EmployeePersonalDetail->blood_group==$key ? 'true' : 'false'}},
            },
        @endforeach
    ],
    renderChoiceLimit: -1,
        ...
        @foreach($accountType as $key => $val)
            {
                value: '{{$key}}',
                label: '{{$val}}',
                selected: {{$country->EmployeeBankDetail->account_type==$key ? 'true' : 'false'}},
            },
        @endforeach
    ],
    renderChoiceLimit: -1,
        ...
        @foreach($genderType as $key => $val)
            {
                value: '{{$key}}',
                label: '{{$val}}',
                selected: {{$country->EmployeePersonalDetail->gender==$key ? 'true' : 'false'}},
            },
        @endforeach
    ],
    renderChoiceLimit: -1,
        ...
        @foreach($workStatusType as $key => $val)
            {
                value: '{{$key}}',
                label: '{{$val}}',
                selected: {{$country->EmployeeEmploymentDetail->work_status==$key ? 'true' : 'false'}},
            },
        @endforeach
    ],
    renderChoiceLimit: -1,
        ...
        @foreach($relationshipType as $key => $val)
            {
                value: '{{$key}}',
                label: '{{$val}}',
                selected: {{$country->EmployeeEmergencyDetail->relationship==$key ? 'true' : 'false'}},
            },
        @endforeach
    ],
    renderChoiceLimit: -1,
    ...
    choices: [
            {
                ...
                @if(!$country->EmployeeEmploymentDetail->work_status==2)
                selected: true,
                @endif
                disabled: true,
            },
        @foreach($exitMode as $key => $val)
            {
                ...
                selected: {{$country->EmployeeEmploymentDetail->ExitMode->id==$val->id ? 'true' : 'false'}},
                @endif
            },
        @endforeach
    ],
...
.addField('#first_name', [
  ...
  .addField('#jurysoft_id', [
    {
      rule: 'required',
      errorMessage: 'Jurysoft ID is required',
    },
    {
        rule: 'customRegexp',
        value: /^[a-zA-Z0-9\-]*$/,
        errorMessage: 'Jurysoft ID is invalid',
    },
  ])

                                ...
                                <table class="table align-middle table-nowrap" id="customerTable">
                                    <thead class="table-light">
                                        <tr>
                                            ...
                                            <th class="sort" data-sort="customer_name">Company Email</th>
                                            <th class="sort" data-sort="customer_name">Personal Phone</th>
                                    ...
                                    <tbody class="list form-check-all">
                                        ...
                                        <tr>
                                            <td class="customer_name">{{$item->jurysoft_id}}</td>

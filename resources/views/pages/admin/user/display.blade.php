                        ...
                        <div class="text-muted">
                            ...
                            <div class="pt-3 pb-1 mt-4">
                                <div class="row">
                                    <div class="col-lg-3 col-sm-6">
                                        <div>
                                            <p class="mb-2 text-uppercase fw-medium fs-13">Jurysoft ID :</p>
                                            <h5 class="fs-15 mb-0">{{$country->jurysoft_id}}</h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="pt-1 pb-3 border-bottom border-bottom-dashed mt-4">
                                <div class="row">
                                    <div class="col-lg-3 col-sm-6">
                                        <div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-sm-6">
                                        <div>
                                            ...
                                            <h5 class="fs-15 mb-0">{{$country->EmployeeEmergencyDetail->name}}</h5>
                                        </div>
                                    </div>
                                    <div class="col-lg-3 col-sm-6">
                                        <div>
                                            <p class="mb-2 text-uppercase fw-medium fs-13">Phone :</p>
                                            <h5 class="fs-15 mb-0">{{$country->EmployeeEmergencyDetail->phone}}</h5>
                                        </div>
                                    </div>
                                    <div class="col-lg-3 col-sm-6">
                                        <div>
                                            <p class="mb-2 text-uppercase fw-medium fs-13">Relationship :</p>
                                            <h5 class="fs-15 mb-0">{{$relationshipType[$country->EmployeeEmergencyDetail->relationship]}}</h5>
                                        </div>
                                    </div>
                                    
                                </div>
                            </div>
                            <div class="pt-1 pb-3 mt-4">
                                <div class="row">

                                    <div class="col-lg-12 col-sm-12 text-center">
                                        <hr/>
                                        <h3>Employment Status Info</h3>
                                        <hr/>
                                    </div>
                                </div>
                            </div>

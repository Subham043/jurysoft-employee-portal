                            ...
                            <div class="row gy-4">
                                <div class="{{$ctc ? 'col-xxl-6 col-md-6' : 'col-xxl-12 col-md-12'}}">
                                    <div>
                                        ...
                                        <input type="text" class="form-control" oninput="main_gross_salary_change()" name="main_gross_salary" id="main_gross_salary" value="{{$country->ctc}}"">
                                ...
                                <div class="col-xxl-6 col-md-6">
                                    <div>
                                        ...
                                        <input type="month" class="form-control" name="month_year" id="month_year" value="{{$ctc->month_year_unformatted}}" max={{$max_month ? $max_month : ''}} {{$min_month ? 'min='.$min_month : ''}}>
                                        @error('month_year') 
                                            <div class="invalid-message">{{ $message }}</div>
                                        @enderror
                                    </div>

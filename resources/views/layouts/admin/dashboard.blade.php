...
<head>
        ...
        <meta charset="utf-8" />
        <title>Jurysoft - Dashboard</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <meta content="Premium Multipurpose Admin & Dashboard Template" name="description" />
        <meta content="Themesbrand" name="author" />
        <!-- App favicon -->
        <link rel="apple-touch-icon" sizes="57x57" href="{{ asset('admin/images/logo-sm.png') }}">
        <link rel="apple-touch-icon" sizes="60x60" href="{{ asset('admin/images/logo-sm.png') }}">
        <link rel="apple-touch-icon" sizes="72x72" href="{{ asset('admin/images/logo-sm.png') }}">
        <link rel="apple-touch-icon" sizes="76x76" href="{{ asset('admin/images/logo-sm.png') }}">
        <link rel="apple-touch-icon" sizes="114x114" href="{{ asset('admin/images/logo-sm.png') }}">
        <link rel="apple-touch-icon" sizes="120x120" href="{{ asset('admin/images/logo-sm.png') }}">
        <link rel="apple-touch-icon" sizes="144x144" href="{{ asset('admin/images/logo-sm.png') }}">
        <link rel="apple-touch-icon" sizes="152x152" href="{{ asset('admin/images/logo-sm.png') }}">
        <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('admin/images/logo-sm.png') }}">
        <link rel="icon" type="image/png" sizes="192x192"  href="{{ asset('admin/images/logo-sm.png') }}">
